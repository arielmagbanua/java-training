...
public static int NUM_TESTS = 5000;
	...
	private static <T> boolean compareLists(LinkedList<T> list1, vector.Vector<T> list2) {
	...
	public static void main(String[] args) {
		...
		vector.Vector<Integer> awts = new vector.Vector<Integer>();
		awts.insertAtHead(2);
		awts.insertAtHead(3);
		awts.insertAtTail(5);
		awts.insertAt(1, 45);
		int test = awts.find(3);
		System.out.println(test); // should be 0
	}
